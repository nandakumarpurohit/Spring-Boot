...
public class EmployeeDaoImpl extends JdbcDaoSupport implements EmployeeDao{
	...
	public void insertEmployee(Employee emp) {
		String sql = "INSERT INTO employee1000 " +
	...
	public void insertEmployees(final List<Employee> employees) {
		String sql = "INSERT INTO employee1000 " + "(empId, empName) VALUES (?, ?)";
	...
	public List<Employee> getAllEmployees(){
		String sql = "SELECT * FROM employee1000";
	...
	public Employee getEmployeeById(String empId) {
		String sql = "SELECT * FROM employee1000 WHERE empId = ?";
